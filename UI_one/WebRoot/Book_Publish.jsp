   ...
   <div id="wrap">
	...
	<div class="container-fluid">
		<div class="row-fluid">
			...
			<div class="span10">
				<div class="hero-unit">
					<form class="form-horizontal" action="FileUp.action" method="post"  enctype="multipart/form-data">
					   
							  <div class="control-group">
							    <label class="control-label" for="inputEmail">书籍名称</label>
							    <div class="controls">
							      <input type="text" name="" placeholder="书籍名称" ">
							    </div>
							  </div>
							  <div class="control-group">
							 ...
							 <option value="七成">七成</option>
							    ...
							    <div class="controls">
							      <input type="text" name="" placeholder="书籍数量" ">
							    </div>
							  </div>
							  	  <div class="control-group">
							    <label class="control-label" for="inputPassword">书籍价格</label>
							    <div class="controls">
							      <input type="text"name="" placeholder="书籍价格" ">
							    </div>
							  </div>
							  	  <div class="control-group">
